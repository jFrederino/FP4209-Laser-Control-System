...
#### Fixed double peak bug in FP interferometer data
This was due to the enable and disable laser methods putting the laser into an unstable setup. This has now been fixed. 

## Characterization of Laser spectrum
Using the 'glorified block of glass' FP interferometer.
